            ...
            public void onClick(View v){
                ...
                if(v.getId()==R.id.SaveInfoButt){
                    ...
                    if(sName.isEmpty()||sBloodTP.isEmpty()||lMainCont==0||lID==0)
                        Toast.makeText(PersonalInfo.this,"Erro:Falta preencher,pelo menos, 1 campo", Toast.LENGTH_LONG).show();
                    else
                        ...
                        if(oCtemp.getCount()<0){
                            ...
                            Toast.makeText(PersonalInfo.this,"Informação Registada com sucesso", Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(PersonalInfo.this,"Erro:Não foi possivel registar a informação", Toast.LENGTH_LONG).show();
                }
            }
        }
